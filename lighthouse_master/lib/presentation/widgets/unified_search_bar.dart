...
class UnifiedSearchBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final iconColor = isDark ? Colors.white70 : AppTheme.artDecoTeal;
                ...
                child: Row(
                  ...
                  children: [
                    _buildFeatureIcon(context,
                        icon: Icons.language, label: 'Web', color: iconColor),
                    _buildFeatureIcon(context,
                        icon: Icons.image, label: 'Image', color: iconColor),
                    _buildFeatureIcon(context,
                        icon: Icons.mic, label: 'Voice', color: iconColor),
                    _buildFeatureIcon(context,
                        icon: Icons.qr_code_scanner, label: 'Scan', color: iconColor),
                  ],
                ),
              ),
          ],
